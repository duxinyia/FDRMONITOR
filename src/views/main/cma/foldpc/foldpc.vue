...
export default {
  ...
  data() {
    return {
      ...
      tableCols: [],
      tableWidths: [100, 80, 400, 100, 100],
      targetArr: {},
      // 红 绿  黄
  ...
  methods: {
    ...
    async initData() {
      let requestArr = [
        getTableList({ device: this.device, DefectType: "DPC", SearchType: "GoldenTag" }),
        getTableList({ device: this.device, DefectType: "DPC", SearchType: "Line" })
      ]
